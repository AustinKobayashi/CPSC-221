...
// #pragma omp task shared (variables) untied
// 
//  have child thread do stuff
//
// #pragma omp taskwait
...
void findStatsHelper(Node * root, double &avg, double &var, int &count) {
    ...
    // Tree with 1100 nodes has height of 10.1 = 10 (this will only have 1023 nodes)
    // Tree of height 11 can have 1100 nodes but can have more so we ignore it
