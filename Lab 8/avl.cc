...
void balance( Node *& x ) {
    ...
    if(diff < -1 || diff > 1){
        ...
        // The left side of the tree is too large
        if(diff > 1){
            
            // If the left side of the left subtree is larger, rotateRight
            // Ie) if the case is LL:
            //      *
            //     /
            //    *
            //   /
            ...
            // If the left right of the left subtree is larger, doubleRotateRight
            // Ie) if the case is LR:
            //      *
            //     /
            //    *
            //     \
        ...
        // The right side of the tree is too large
        } else if (diff < -1){
            
            // If the right side of the right subtree is larger, rotateLeft
            // Ie) if the case is RR:
            //    *
            //     \
            //      *
            //       \
            ...
            // If the left side of the right subtree is larger, doubleRotateLeft
            // Ie) if the case is RL:
            //    *
            //     \
            //      *
            //     / 
